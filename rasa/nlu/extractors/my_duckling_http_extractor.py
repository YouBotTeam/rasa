...
def convert_duckling_format_to_rasa(
    ...
    for match in matches:
        ...
        # my custom code
        try:
            if entity["entity"] == "amount-of-money" and entity["additional_info"]["type"] == "interval":
                entity["entity"] = "interval-of-money"
...
class myDucklingHTTPExtractor(EntityExtractor):
    ...
    def process(self, message: Message, **kwargs: Any) -> None:
        ...
        if self._url() is not None:
            ...
            dimensions = self.component_config["dimensions"]
            extracted = myDucklingHTTPExtractor.filter_irrelevant_entities(
    ...
    def load(
        ...
        cached_component: Optional["myDucklingHTTPExtractor"] = None,
        **kwargs: Any,
    ) -> "myDucklingHTTPExtractor":
